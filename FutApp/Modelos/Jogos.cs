...
public class Jogo 
{
    ...
    public int? MaxJogadores { get; set; } // Atributo opcional
    ...
    {
        return $"Jogo {Id} em {Data.ToShortDateString()} no {Local} - Campo: {TipoCampo}, {JogadoresPorTime} por time, Máx: {MaxJogadores ?? 0}, Interessados: {Interessados.Count}";
    }
}
